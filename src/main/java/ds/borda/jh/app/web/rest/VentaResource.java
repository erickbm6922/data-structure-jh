...
/**
 * REST controller for managing {@link ds.borda.jh.app.domain.Venta}.
 */
@RestController
@RequestMapping("/api")
public class VentaResource {
     ...
     */
    @GetMapping("/ventas")
    public ResponseEntity<List<VentaDTO>> getAllVentas(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
