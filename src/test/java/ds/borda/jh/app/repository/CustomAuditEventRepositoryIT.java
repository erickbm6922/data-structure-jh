...
import ds.borda.jh.app.config.audit.AuditEventConverter;
import ds.borda.jh.app.domain.PersistentAuditEvent;
...
import static ds.borda.jh.app.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
